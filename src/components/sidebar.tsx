...
import { LayoutDashboard, FolderKanban, Sparkles, History, Settings, Zap, X } from 'lucide-react'
        ...
        <div className="flex h-full flex-col bg-card text-card-foreground">
            ...
            <div className="p-4 border-t border-border space-y-4">
                <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-xl p-4 relative overflow-hidden">
                    ...
                    <div className="text-2xl font-bold text-foreground relative z-10">{user?.credits}</div>
